                        ...
                        <AlertDialog open={isConfirmOpen} onOpenChange={closeConfirm}>
                            <AlertDialogContent className="rounded-[2rem] border-amber-100 bg-[#fffdf7] p-8 text-[#5b3a1e] shadow-xl">
                                <AlertDialogHeader className="text-center">
                                    ...
                                    <AlertDialogTitle className="text-2xl font-bold text-[#6b4226]">
                                        図書情報を変更しますか？
                                    </AlertDialogTitle>

                                    <AlertDialogDescription className="pt-4 text-[#8a6b4f]">
                                        <div className="mx-auto max-w-sm space-y-3 rounded-2xl border border-amber-100 bg-amber-50/70 p-4 text-center">
                                            <p>
                                ...
                                <AlertDialogFooter className="mt-6 gap-3 sm:justify-center">
                                    ...
                                    <AlertDialogAction
                                        ...
                                        className="rounded-full bg-orenge-500 px-8 font-bold text-white hover:bg-amber-600"
                                    >
                                        変更する
                                    </AlertDialogAction>
                                </AlertDialogFooter>
